...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/gen-strings.js");
/******/ })
/************************************************************************/
/******/ ({
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* WEBPACK VAR INJECTION */(function(fetch) {/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "testMe", function() { return testMe; });
...
function testMe() {
  getCurrencyList(function (error, result) {
    if (error) {
    ...
    fetch("https://api.exchangeratesapi.io/latest?base=" + selectedCurrencies[0].currency).then(function (response) {
...
globalThis['testMe'] = __skpm_run.bind(this, 'testMe');
globalThis['onRun'] = __skpm_run.bind(this, 'default')

//# sourceMappingURL=__gen-strings.js.map